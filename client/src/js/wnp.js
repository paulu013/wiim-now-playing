    ...
    socket.on("metadata", function (msg) {
        ...
        if (heroLogoMode) {
            if (WNP.r.wnpHeroLogo) {
                ...
                // Progress ON: sit just above the footer; measure it so the logo clears both
                // the short /tv footer and the taller normal-view footer. Progress OFF: the
                // drop-lower offset is handled in CSS (--art-logo-bottom-hidden). (fork)
...
WNP.devLayout = {
    ...
    props: [
        ...
        { group: "Artwork – clear logo", key: "artLogoBottom", label: "Bottom (progress on)", css: "--art-logo-bottom", min: 0, max: 40, step: 0.5, unit: "vh", def: null },
        { group: "Artwork – clear logo", key: "artLogoBottomHidden", label: "Bottom (progress off)", css: "--art-logo-bottom-hidden", min: 0, max: 40, step: 0.5, unit: "vh", def: 3 },
        ...
        { group: "Artwork – source logo", key: "artSrcBottom", label: "Bottom (progress on)", css: "--art-source-bottom", min: 0, max: 40, step: 0.5, unit: "vh", def: 3 },
        { group: "Artwork – source logo", key: "artSrcBottomHidden", label: "Bottom (progress off)", css: "--art-source-bottom-hidden", min: 0, max: 40, step: 0.5, unit: "vh", def: 3 },
        { group: "Artwork – source logo", key: "artSrcMaxH", label: "Height", css: "--art-source-maxh", min: 2, max: 20, step: 0.5, unit: "vh", def: 5 },
        { group: "Artwork – video info (year/director)", key: "artMetaScale", label: "Text scale", css: "--art-meta-scale", min: 0.5, max: 2, step: 0.05, unit: "", def: 1 },
        { group: "Artwork – video info (year/director)", key: "artMetaX", label: "Offset X", css: "--art-meta-x", min: -20, max: 20, step: 0.5, unit: "vw", def: 0 },
        { group: "Artwork – video info (year/director)", key: "artMetaY", label: "Offset Y", css: "--art-meta-y", min: -20, max: 20, step: 0.5, unit: "vh", def: 0 },
